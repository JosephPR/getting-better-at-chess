...
function GiuocoPiano() {
  return (
    <>
   <h1>Giuoco Piano</h1>
<p><img class="alignright" title="Giuoco Piano" src="https://374999-1254560-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2015/08/the-giuoco-piano.jpg" alt="Giuoco Piano" width="250" height="250" /></p>
<p>The Giuoco Piano is said to be the oldest opening recorded in chess. Instead of developing the bishop to b5, white instead attacks the center and aims at the weak f7 square. After black responds bishop to c5 you see the tension building up in the center of the board.</p>
<p>1. e4 e5<br />2. Nf3 Nc6<br />3. Bc4 Bc5</p>
